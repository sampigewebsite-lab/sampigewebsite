...
export default async function ContactPage() {
  ...
  const orgData = settings?.value || {
    email: 'sampigefoundation@gmail.com',
    phone: '+91 1234567890',
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm font-medium leading-relaxed">{orgData.address}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-black rounded-lg border border-gold-500/20 text-gold-500">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm font-medium">Mon - Sat: 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
